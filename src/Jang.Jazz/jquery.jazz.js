var jazz = (function ($) {
    ...
    // Represents the base jazz object.
    var jazz = {
    ...
    /* Register our jQuery function. */
    if (jQ) {
        // Parses the text values of the query results using the specified model.
        $.fn.jazz = function (model) {
            var text = $(this).text();
            return jazz.parse(text, model);
        };
    }
...
jazz = (typeof (jQuery) === "undefined") ? jazz() : jazz(jQuery);